...
class Ns9 < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.34/ns9-0.1.34-macos-arm64-py3.12.tar.gz"
      sha256 "1e236521ccb723bfc292db4ba19383f89eaf4951d2d7239b91f6fe42660d345e"
    end
    on_intel do
      ...
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.34/ns9-0.1.34-macos-x86_64-py3.12.tar.gz"
