...
class Ns9 < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.19/ns9-0.1.19-macos-arm64-py3.12.tar.gz"
      sha256 "c3bea80d479fa320e1eadad8703efd45856fbb1303cc7f91be4e6de5351e88fe"
    end
    on_intel do
      ...
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.19/ns9-0.1.19-macos-x86_64-py3.12.tar.gz"
