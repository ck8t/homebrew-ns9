...
class Ns9 < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.9/ns9-0.1.9-macos-arm64-py3.12.tar.gz"
      sha256 "9b442819f7ba84d8596fe827e375b9c07f2c03de5c9b6add4de4f45da2ebede3"
    end
    on_intel do
      ...
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.9/ns9-0.1.9-macos-x86_64-py3.12.tar.gz"
