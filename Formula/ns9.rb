...
class Ns9 < Formula
  ...
  on_macos do
    on_arm do
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.54/ns9-0.1.54-macos-arm64-py3.12.tar.gz"
      sha256 "de3dec619af237cdbdb68505e9d565543f49bd083348e7370ad41ad28423ac30"
    end
    on_intel do
      ...
      url    "https://github.com/ck8t/ns9/releases/download/v0.1.54/ns9-0.1.54-macos-x86_64-py3.12.tar.gz"
